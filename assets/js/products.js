...
(async function () {
  ...
  try {
    ...
    console.error(err);
    if ($grid) $grid.innerHTML = '<p style="opacity:.8">No pudimos cargar los productos. Verifica la ruta de <code>assets/products.json</code>.</p>';
    return;
  }
  ...
  function render(lista) {
    ...
    lista.forEach(p => {
      ...
      const tel = '595XXXXXXXX'; // ← reemplazar luego por tu número sin + ni 0
